  ...
  <div class="bar">
    ...
    <div class="fullscreen-bg">
      <video loop muted autoplay playsinline class="fullscreen-bg__video">
        <source
          src="https://player.vimeo.com/external/401375408.hd.mp4?s=bbf37b1601af62db2a1758fd0d63b6f23c5f2623&profile_id=175"
          type="video/mp4"
        />
      </video>
    </div>
    ...
    return {
      services: [
        ...
        },
        {
          ...
          description:
            'Fundraising for an organisation driving actions that will impact the lives of millions living in poverty around the world'
        },
        {
          name: 'Karada House',
          href:
            'https://www.betterplace.me/emergency-relief-for-queers-und-womxn',
          description:
        ...
        },
        {
          ...
          description:
            'Fundraising for an organisation that rescues refugees in the Mediterranean.'
        },
        {
          name: 'TS Raver',
          href: 'https://paypal.me/pools/c/8nKshvWZdC',
          description:
            'Fundraising for Berlin based awareness collective providing club care.'
        },
        {
          name: 'Viva con Agua',
          href: 'https://www.vivaconagua.org/index.htm?spende',
          description:
            'Fundraising for an organisation focussed on providing clean drinking water.'
        },
        {
